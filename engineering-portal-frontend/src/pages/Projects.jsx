...
function ProjectCard({ project, onArchive, onDelete }) {
  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl border border-surface-200 hover:shadow-hover hover:border-surface-300 transition-all duration-200 overflow-hidden group">
      {/* Header */}
